...
//   changeListener(BuildContext context, int playlistID) async {
//     songList =
//         await Provider.of<DatabaseValue>(context).getPlaylistSongs(playlistID);
//     // print(songList);
//     Provider.value(
//       value: DatabaseValue,
//     );
...
//   setPlaylist() async {
//     await player.setFilePath(songList[0].songPath,
//         initialPosition: Duration.zero);
//     // await player.setAudioSource(ConcatenatingAudioSource(
//     //     children: [AudioSource.uri(Uri.parse(songList[0].songPath))]));
//   }
